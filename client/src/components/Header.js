  ...
  return (
    <header className="flex items-center justify-between flex-wrap bg-neutral-800 p-6">
      <div className="flex items-center flex-shrink-0 text-lime-400 mr-6">
        <Link to="/"><span className="font-bold text-6xl">NeuPixl</span></Link>
      </div>
      <div>
        ...
        <Link to="/login"  className="inline-block text-md px-4 py-2 leading-relaxed border rounded border-lime-400 text-lime-400 hover:bg-lime-400 hover:text-neutral-800 mt-4 md:mt-0"> Log In</Link>
      </div>
    </header>
  );
};
